    ...
    <>
      ...
      <main className="md:px-50 flex min-h-screen flex-col items-center justify-center bg-stitched-black p-8 md:flex-row">
        <div className="flex flex-col items-start space-y-4 md:space-y-8">
          ...
          <Link
            className="inline-flex cursor-pointer items-center justify-center rounded border border-stitched-pink px-6 py-3 text-lg leading-none text-white transition duration-300 ease-in-out hover:border-transparent hover:bg-white hover:text-stitched-pink md:text-xl"
            href="/home"
          >
            Get Started
            <svg
