...
function Navbar() {
    const staticStyles = "inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-[#2e026d] hover:bg-white";
    return (
        ...
        <nav className="flex justify-between items-center bg-transparent p-6 top-0 sticky">
