...
function SwipeableComponent() {
  ...
  const recommendationAdd = api.recommendation.recommendationAdd.useMutation();
...
return (
  <div className="flex items-center h-screen justify-center overflow-x-hidden overflow-y-hidden  bg-stitched-black text-white border ">
